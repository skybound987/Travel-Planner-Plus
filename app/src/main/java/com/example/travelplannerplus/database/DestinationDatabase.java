...
@Database(entities = {Destination.class, DestinationActivities.class}, version = 0, exportSchema = false)
public abstract class DestinationDatabase extends RoomDatabase {
    public abstract DestinationInterface destinationInterface();
    public abstract DestinationActivitiesInterface destinationActivitiesInterface();
